...
public class EmployeesActivity extends ActionBarActivity
        implements EmployeesNavigationDrawerFragment.NavigationDrawerCallbacks,
        FragmentBase.OnFragmentInteractionListener {

    private final static String TAG = "EmployeesActivity";

    /**
     * Fragment managing the behaviors, interactions and presentation of the navigation drawer.
     */
    private EmployeesNavigationDrawerFragment mEmployeesNavigationDrawerFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmployeesNavigationDrawerFragment = (EmployeesNavigationDrawerFragment)
                getSupportFragmentManager().findFragmentById(R.id.navigation_drawer);
        mTitle = getTitle();

        // Set up the drawer.
        mEmployeesNavigationDrawerFragment.setUp(
