...
public class UniversalImageLoaderCard extends Card {
    ...
    class UniversalCardThumbnail extends CardThumbnail {
        ...
        private String thumbnailURL = "no_picture.gif";
        ...
        public void setupInnerViewElements(ViewGroup parent, View viewImage) {
            ...
            if (((UniversalImageLoaderCard) getParentCard()).getCount() % 2 == 0) {
                imageLoader.displayImage("http://acacha.org/acacha_manager/uploads/school_logos/logo_InstitutEbre.png", (ImageView) viewImage,options);
            } else {
                imageLoader.displayImage("drawable://" + android.R.drawable.ic_lock_power_off , (ImageView) viewImage,options);
            }
